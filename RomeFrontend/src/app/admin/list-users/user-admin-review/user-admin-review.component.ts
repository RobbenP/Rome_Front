...
export class UserAdminReviewComponent implements OnInit {
  ...
  private getReviews() {
    this.reviewService.getReviewsFromUser(this.userID).subscribe(result => {
      this.reviewFromModel = result;
      this.userService.getUsers().subscribe(result => {
        this.users = result;
        this.assignmentService.getAssignments().subscribe(result => {
          this.assignments = result;
        });
      });
    });
    this.reviewService.getReviewsAboutUser(this.userID).subscribe(result => {
